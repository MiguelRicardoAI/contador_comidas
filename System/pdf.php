...
<html lang="en">
  ...
  <body>
      ...
      <div class="col-md-7 col-md-offset-5">
        ...
        <div class="col-md-7 col-md-offset-5">
        <select class="selectpicker" id="hotel" data-style="btn-primary" data-size="5">
          <optgroup label="Hotel">
          <option value="1">Angel Inn</option>
        ...
        <select class="selectpicker" id="cbowork" data-live-search="true" data-style="btn-primary" data-size="5">
          ...
          <option value="15w5016">15w5016</option>
      ...
      <div class="col-md-2 col-md-offset-5">
        ...
        <input type="button" class="btn-primary  btn-block" value="Generate PDF" id="pdf"/>
        </div>
      </div>
      </div> <!-- /container -->
      </p>
